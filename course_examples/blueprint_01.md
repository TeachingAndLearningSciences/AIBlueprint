...
|-----------------------------|---------------------------------------------------------------------------------|------| 
| LO_C01  |Students are able to understand and describe the core principles and process steps that are part of Behavior-Driven Development and of Behavior-Driven Testing. | [EXPLAIN] | 
...
|-----------------------------|------------------------------------------------------------------------------|---|------|---|
| LO_AI01                         | Students are able to use an AI assistant to query for explanations about the core concepts, phases, and elements of BDD and respective tools. | [EXPLAIN] | [AI-Usage: Explain] | LO_C01 | 
