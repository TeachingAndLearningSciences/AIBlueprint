...
|---------------------------|------------------------------------------------|----|---|
| LO_AI1  |  Students are able to use an AI assistant to query for explanations about the core concepts, phases, and elements of BDD and respective tools. | [EXPLAIN]|[Explain]|
| LO_AI2  | Students are able to draft Gherkin feature files from user stories or requirements in the given-when-then format  |[APPLY] |[GENERATE]|
|LO_AI3 | Students are able to interpret AI-generated test cases and relate them to intended behaviors.  |[APPLY]|[Evalute] |
| LO_AI4  |  Students are able to assess and refine simple  BDD scenarios generated by an AI tool and critically assess their accuracy and relevance, and further refine them when needed.  | [EVALUATE] |[Refine]|
